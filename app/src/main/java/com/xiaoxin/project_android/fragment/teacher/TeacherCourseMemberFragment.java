...
import com.xiaoxin.project_android.adapter.MemberAdapter;
...
public class TeacherCourseMemberFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        NetUtil.getNetData("courseStudent/findAllStudentByCourseId",map,getStudentHandler);
        refreshLayout.setColorSchemeColors(ViewUtils.getRefreshColor());
        refreshLayout.setOnRefreshListener(() -> NetUtil.getNetData("courseStudent/findAllStudentByCourseId",map,getStudentHandler));
    }
