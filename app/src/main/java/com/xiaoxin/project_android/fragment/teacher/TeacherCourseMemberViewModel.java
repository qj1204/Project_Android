...
public class TeacherCourseMemberViewModel extends ViewModel {
    ...
    public void updateStudentList(String s){
        ...
        for (int i = 0; i < object.size(); i++) {
            ...
            student = new Student(stu.getInteger("studentId"),stu.getString("studentAccount"),stu.getString("studentPassword"),stu.getString("studentName"),stu.getInteger("studentSex"),
