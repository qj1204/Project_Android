...
public class MapChooseActivity extends AppCompatActivity {
    ...
    @OnClick({R.id.map_my_location1, R.id.map_choose_location, R.id.action_bar_back})
    public void onClick(View view){
        switch (view.getId()){
            case R.id.map_my_location1:
    ...
    public BaiduMap.OnMapClickListener onMapClickListener = new BaiduMap.OnMapClickListener() {
        ...
        public void onMapClick(LatLng latLng) {
            ...
            OverlayOptions option = new MarkerOptions().position(latLng)
                    .icon(BitmapDescriptorFactory.fromResource(R.drawable.location_on)).animateType(MarkerOptions.MarkerAnimateType.grow)
