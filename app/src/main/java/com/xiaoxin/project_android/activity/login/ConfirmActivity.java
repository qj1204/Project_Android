...
public class ConfirmActivity extends BaseActivity {
    ...
    Handler mHandler = new Handler(msg -> {
        if (msg.arg1 == SMSSDK.EVENT_SUBMIT_VERIFICATION_CODE && msg.arg2 == SMSSDK.RESULT_COMPLETE){
            showToast("验证成功！！！");
            Map<String, String> map = CommonUtil.object2Map(student);
            NetUtil.getNetData("account/registerStudent", map, registerHandler);
    ...
    protected void initView() {
        codeEdit = findViewById(R.id.confirm_code);
        resend = findViewById(R.id.confirm_resend);
        confirm = findViewById(R.id.confirm_confirm);
