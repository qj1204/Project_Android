...
/**
 * @ProjectName: LocalDemo
 * @Package: com.dai.okhttp.util
...
public class OkHttpUtils {
    ...
    public OkHttpUtils setHeaderMap(Map<String, String> headerMap) {
        this.headerMap = headerMap;
        return this;
    }

    public OkHttpUtils setParamMap(Map<String, String> paramMap) {
    ...
    private OkHttpUtils(int timeout) {
        if (okHttpClient == null) {
            synchronized (OkHttpUtils.class) {
                if (okHttpClient == null) {
                    TrustManager[] trustManagers = buildTrustManagers();
     ...
     * @return
     */
    public static OkHttpUtils builder(int timeout) {
        return new OkHttpUtils(timeout);
    }
    ...
    public OkHttpUtils get() {
        ...
        Log.d("发送的请求为",urlBuilder.toString());
