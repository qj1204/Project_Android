...
public class LeaveCreateDialog extends Dialog {
    ...
    private void initEvent() {
        yes.setOnClickListener(v -> {
            ...
            endTime = new Timestamp(startTime.getTime() + 1000*3600*integer);
            Log.d("start--end",startTime + "--" + endTime);
    ...
    public void onClick(){
        ...
        dateTimeDialog.setOnSureLisener(date -> {
            ...
            start.setText(new SimpleDateFormat(Static.DATE_FORMAT_MINUTE, Locale.CHINA).format(startTime));
        });
        dateTimeDialog.show();
    }
