...
public class AttendCreateDialog extends Dialog {
    ...
    Handler createAttendHandler = new Handler(message -> {
        if (message.what == 1){
            dismiss();
        }
        loadingDialog.setMessage(message.getData().getString("msg"));
    ...
    private void initEvent(){
        ...
        timeEnd.setOnClickListener(v -> {
            ...
            dateTimeDialog.setOnSureLisener(date -> {
                ...
                timeEnd.setText(new SimpleDateFormat(Static.DATE_FORMAT_MINUTE, Locale.CHINA).format(endTime));
            });
            dateTimeDialog.show();
        });
        ...
        timeStart.setOnClickListener(v -> {
            ...
            dateTimeDialog.setOnSureLisener(date -> {
                ...
                timeStart.setText(new SimpleDateFormat(Static.DATE_FORMAT_MINUTE,Locale.CHINA).format(startTime));
            });
            dateTimeDialog.show();
        });
